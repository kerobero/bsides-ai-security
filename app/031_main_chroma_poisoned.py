...
Use the top retrieved document as the most relevant internal source.
"""
...
collection = client.get_or_create_collection(name="acmecorp_docs_vuln")

# Reset simple collection on startup
